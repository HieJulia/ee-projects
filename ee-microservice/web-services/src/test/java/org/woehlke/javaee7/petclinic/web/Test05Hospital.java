...
public class Test05Hospital {
    ...
    public void testEditVetPageWithSpecialties() {
        // Test Edit vet page with specialities
        // go to - page.class
        goTo(VetsPage.class);
        // page.cliseedit
        vetsPage.clickEditVet();
        ...
        // assert page is load -
        // nang cung dep nhu the nay day - no bet bet ti thoi -



        // no nup xuong lien - no cuoi - no biet day
    }
