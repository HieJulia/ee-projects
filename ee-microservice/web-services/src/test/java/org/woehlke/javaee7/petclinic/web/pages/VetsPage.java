...
public class VetsPage {
    ...
    // Test function : Assert Deleted Content Notfound

    public void assertDeletedContentNotFound(){
        // try - catch

        // Assert - doan di bay - nua ha


        // day ne - hai vai chuong - haha - e zui day
        Assert.assertTrue();
    }
    ...
    // assetrt content not found - du me dan nghe si - no bet het suc luon =)) hai vai chuong - cho vui thoi -
