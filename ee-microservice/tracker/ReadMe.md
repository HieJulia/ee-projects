...
# Stack 
+ Application server : Payara Server 5, GlassFish, WildFly, WebSphere Liberty
+ JavaEE
+ Architecture : Microservices 
    + Fat jar 
    + Health, Configuration, Containerized deployments, Cloud deployments - JavaEE, MicroProfile, Docker, AWS 
